...
const Navbar = () => {
    ...
    return (
        <div className="h-[70px] bg-gray-700 text-white z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
                <Link to="/" className="flex items-center text-2xl font-bold">
                    <FaStore className="mr-2 text-3xl" />
                    <span className="font-[Poppins]">EBDify - Shop Smart</span>
                </Link>
            ...
            navbarOpen ? "h-fit sm:pb-0 pb-5 bg-gray-800" : "h-0 overflow-hidden"
                ...
                <li className="font-[500] transition-all duration-150">
                   <Link className="flex items-center space-x-2 px-4 py-[6px] 
                            ...
                            hover:from-purple-500 hover:to-purple-500 transition 
